...
import { TransfersFundAssetListUser } from "../../services/srvc-transfers-funds-realm";

export default function AssetsListUserFundedModule () {
  ...
  useEffect( () => {
    if (asset){
      ...
      const fetchData = async() => {
        ...
        const result = await TransfersFundAssetListUser({data: {user: asset.item}})
        console.log (result)
