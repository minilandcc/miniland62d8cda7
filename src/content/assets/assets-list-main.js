...
const list = require('../../data.static/data-assets-list.json').data
      ...
      <div className="mb-3">
        ...
        {data && data.map((item, i) => (
          <div className="col m-0 mb-3" key={i}>
            ...
            <div className="card h-100 rounded-xd border-none p-0 m-0 back-color-wite"
            ...
            >
              ...
              <div className="media-standard rounded-xd rounded-bottom-none">
                <img
                  ...
                  layout='fill'
                  className="img-fluid w-100 rounded-xd shadow"
                  alt="..."
                />
                ...
                <div className="">
                  <div className="progress" 
                    ...
                    <div 
                      ...
                      style={{width:`${(item.units.done/item.units.mint)*100}%`, height: '0.33rem'}}></div>
                  </div>
                </div>
