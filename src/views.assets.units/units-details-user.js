...
import AssetUnitDetailsUserModule from "../content/assets.units/units-details-user";
import AssetUnitActionsUserModule from "../content/assets.units.actions/units-actions-user";

export default function AssetsUnitsDetailsUser () {
