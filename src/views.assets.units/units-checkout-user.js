...
import UnitsCheckoutUserModule from "../content/assets/units-checkout-user";


export default function AssetsUnitsCheckoutUser () {
  ...
  <>
    ...
    <ContentFormat 
      ...
      <>
        <WebbDividerSmall />
        <h2 className="text-normal text-color-next text-uppercase text-center">Checkout Asset</h2>    
        <p className=""></p>

        <WebbDividerSmall />
        <UnitsCheckoutUserModule />
