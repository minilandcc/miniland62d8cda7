...
import AccountsCreateInrxVirtualModule from "../content/accounts/accounts-create-inrx-bank";

export default function AccountsLinkInrxVirtual
 () {
  ...
  <>
    ...
    <ContentFormat 
      ...
      <>
        <WebbDividerMedium />
        <AccountsCreateInrxVirtualModule />
