...
import AccountsCreateWeb3BinanceModule from "../content/accounts/accounts-create-web3-bnb";

export default function AccountsCreateBinance () {
  
  const metadata = {
    name: 'Create/Link Binance Account',
  ...
  <>
    ...
    <ContentFormat 
      ...
      <>
        <WebbDividerMedium />
        <AccountsCreateWeb3BinanceModule />
