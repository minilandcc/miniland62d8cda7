...
import AccountsMinterModule from "../content/onboard/user-onboard-account-minter";


export default function UserOnboardAccountMinter () {
  
  const metadata = {
    name: 'Digital Assets Account',
