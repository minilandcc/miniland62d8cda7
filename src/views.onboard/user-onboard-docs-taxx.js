...
import UserDocumentsCreateModule from "../content/documents/user-docx-create-taxc";
import UserDocumentsCreateTaxcardModule from "../content/onboard/user-onboard-docs-taxx";

export default function UserOnboardDocsTaxx () {
  
  const metadata = {
    name: 'Add Documents: Pan Card',
  ...
  <>
    ...
    <ContentFormat 
      ...
      <>
        <WebbDividerSmall />
        <UserDocumentsCreateTaxcardModule />
