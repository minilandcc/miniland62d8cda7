...
import UserDocumentsCreateModule from "../content/documents/user-docx-create-adhr";
import UserDocumentsCreateAadhaarModule from "../content/onboard/user-onboard-docs-aadhaar";

export default function UserOnboardDocsAadhaar () {
  
  const metadata = {
    name: 'Add Documents: Aadhaar Card',
  ...
  <>
    ...
    <ContentFormat 
      ...
      header = {{ size: 'fluid', visible: true, data: 
        <> 
          <div className="text-center back-color-lite">
            <WebbHeader data = {{ name: metadata.name, link: 'onboard/start' }}/>
          </div>
        </> }}
      ...
      <>
        <WebbDividerSmall />
        <UserDocumentsCreateAadhaarModule />
